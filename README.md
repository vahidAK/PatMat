...
**Aug 30, 2022:** DMR list updated. Adjacent DMRs were merged. Moreover, we noticed some overlapping DMRs did not merged in a away to show the longest possible merged DMR, so they were merged to a single DMR with longest length.  
